...
import codReserva from '../../pages/cod_reserva/codReserva'
...
describe('Coral', () => {
    ...
    it('Criar Reserva com ativando a Flag Renovacao', () => {
    ...
    it('Editar Reserva', () => {
        ...
        cod_reserva.typeCodReserva('input[id="inputReservationNumber"]{enter}')
